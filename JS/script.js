...
function getData(evt){
    ...
    const data = $.ajax({url:`https://cors-anywhere.herokuapp.com/https://www.wikia.com/api/v1/Wikis/ByString?expand=1&string=${search}&lang=en%2C+es&limit=25&batch=1&includeDomain=true/`,
